...
\end{verbatim}
	...
	\item Copy the startup script \newline \texttt{/fin/devl/iocBoot/templates/slejko/example.startup} to your project and rename it to \texttt{MTEST-VME-EVRTEST\_startup.script} using the following command in your project folder:
\begin{verbatim}
...
Line \texttt{$<$ \$(TEMPLATE\_DIR)/EVR\_VME.startup} includes a generic EVR startup script, and must not be changed by the user.
	...
	\item Copy the substitution file \texttt{/fin/devl/iocBoot/templates/slejko/EVR.subs} to \texttt{MTEST-VME-EVRTEST/cfg/EVR.subs}. This substitution file can always be used as a starting point for new applications. Use the following command in your project folder: 
\begin{verbatim}
