...
dbLoadRecords("db/evrout.db","P=evr:,O=irqmap:,C=0,OT=0,IDX=0")
dbLoadRecords("db/evrout.db","P=evr:,O=fp1:,C=0,OT=1,IDX=0")
dbLoadRecords("db/evrout.db","P=evr:,O=fp2:,C=0,OT=1,IDX=1")
dbLoadRecords("db/evrout.db","P=evr:,O=fp3:,C=0,OT=1,IDX=2")
